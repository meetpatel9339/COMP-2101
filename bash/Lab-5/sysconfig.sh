...
function displayhelp {	
	cat << EOF
  	...
  	$0 [-h |--help]	-> Display various option and it's usages
  	$0 [--host]		-> Display host name
  	$0 [--domain]	-> Display domain name
  	$0 [--ipconfig] 	-> It display IP related information
  	$0 [--os]		-> It display OS related information
  	$0 [--cpu]		-> It display CPU related information
  	$0 [--memory]	-> It display memory related information
  	$0 [--disk]		-> It display disk related information
  	$0 [--printer]	-> It display printer related information
EOF
}
...
trap 'error-message; cleanup;' INT;
